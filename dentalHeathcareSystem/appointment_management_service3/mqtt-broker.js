...
function connectToBroker() {
    ...
    mqttClient.on("connect", () => {
        ...
        subscribeToBroker('appointments-3/topics');
    });
    ...
    mqttClient.on("message",async (topic, payload, packet) => {
        ...
        if(topic.startsWith('appointments-3/topics')){
        ...
        }else if (topic.startsWith( 'appointments-3/create/')) {
        ...
        }else if (topic.startsWith( 'appointments-3/book/')) {
        ...
        }else if (topic.startsWith('appointments-3/get/clinics/available/appointments/')) {
        ...
        }else if (topic.startsWith('appointments-3/get/patient/appointments/')) {
        ...
        }else if (topic.startsWith('appointments-3/get/available/appointments/')) {
        ...
        } else if (topic.startsWith('appointments-3/get/clinic/appointments/')) {
        ...
        }else if (topic.startsWith('appointments-3/get/specific/')){
        ...
        }else if (topic.startsWith('appointments-3/update/')){
        ...
        } else if (topic.startsWith('appointments-3/delete/')) {
        ...
        }else if (topic.startsWith('appointments-3/get/')){
